csdl_goc=[["CSDL quan hệ là?", "tập hợp các bản dữ liệu hông có liên quan với nhau", "tập hợp các bản dữ liệu có iên quan với nhau", "thực hiện các thao tác thêm, ửa, xóa", "tìm kiếm dữ liệu và kết xuất hông tin", 2], ["Truy vấn trong CSDL quan hệ à:", "Tìm kiếm dữ liệu và kết xuất a thông tin cần tìm", "Thao tác thêm, sửa, xóa", "Tạo mối quan hệ giữa các bảng", "Ràng buộc dữ liệu", 1], ["Phát biểu nào sau đây là SAI ề các ràng buộc dữ liệu rong CSDL quan hệ:", "Trong một bảng, không có hai ản ghi nào giống nhau hoàn oàn", "Trong một bảng, mỗi trường ó một tên để phân biệt với ất cả các trường khác", "Mỗi bảng có một tên để phân iệt với các bảng khác trong ùng CSDL", "Mỗi ô của bảng chứa một hay hiều giá trị", 4], ["Chọn phát biểu ĐÚNG  trong ác phát biểu sau:", "Nếu hai bản ghi khác nhau hì giá trị khóa của chúng hải khác nhau", "Trong CSDL quan hệ, mỗi bảng hỉ có 1 khóa", "Khóa của một bảng chỉ là một rường", "Không thể cập nhật dữ liệu ho một bảng khi đã chọn hóa", 1], ["Trong một bảng gồm các rường: CCCD, Họ và tên, gày sinh, Điểm tin. Ta chọn rường nào sau đây làm khóa hính:", "CCCD", "Họ và tên", "Ngày sinh", "Điểm tin", 1], ["Khái niệm \"khóa ngoài\" của ột bảng:", "Một trường (hay một số rường) của bảng này và đồng hời là khóa của một bảng hác", "Một trường trong bảng được ử dụng để xác định các giá rị duy nhất của mỗi hàng", "Một trường trong bảng chứa iá trị ngày tháng", "Một trường trong bảng chứa iá trị số", 1], ["Liên kết giữa hai bảng trong SDL được thực hiện thông ua cặp", "khóa chính – khóa ngoài", "khóa chính – khóa chính", "khóa ngoài – khóa ngoài", "khóa trong – khóa phụ", 1], ["Để tạo biểu mẫu ta chọn đối ượng nào trên bảng chọn đối ượng?", "Queries", "Forms", "Tables", "Reports", 2], ["Trong Access, ta có thể sử ụng biểu mẫu để:", "Tính toán cho các trường ính toán", "Sửa cấu trúc bảng", "Xem, nhập và sửa dữ liệu", "Lập báo cáo", 3], ["Trong Access, muốn tạo biểu ẫu theo cách dùng thuật sĩ, a chọn thẻ Create rồi trên hanh công cụ ta chọn lệnh:", "Form Design", "Form Wizard", "Blank Form", "Form", 2], ["Muốn nhanh chóng có được iểu mẫu theo ý mình, ta có hể", "dùng công cụ thiết kế biểu ẫu tự động, sau đó điều hỉnh thêm để có một biểu ẫu thân thiện, thuận tiện ơn trong sử dụng", "dùng biểu mẫu có sẵn trên hần mềm ứng dụng", "sử dụng khóa ngoài của bảng ể thực hiện ghép nối dữ iệu hai hàng với nhau", "sử dụng khóa chính của bảng ể thực hiện ghép nối dữ iệu hai bảng với nhau", 1], ["Các hệ quản trị CSDL quan hệ hường cung cấp", "công cụ tạo lập nhanh chóng hững biểu mẫu cho xem dữ iệu", "những biểu mẫu hiển thị", "các thuộc tính của đối tượng", "ngôn ngữ lập trình", 1], ["Phát biểu nào sau đây là sai?", "Việc cập nhật dữ liệu trong iểu mẫu thực chất là cập hật dữ liệu trên bảng dữ iệu nguồn", "Việc nhập dữ liệu bằng cách ử dụng biểu mẫu sẽ thuận iện hơn, nhanh hơn, ít sai ót hơn", "Có thể sử dụng bảng ở chế độ rang dữ liệu để cập nhật dữ iệu trực tiếp", "Khi tạo biểu mẫu để nhập dữ iệu thì bắt buộc phải xác ịnh hành động cho biểu mẫu", 4], ["Truy vấn CSDL là:", "Một tập hợp các bảng dữ liệu ó liên quan với nhau", "Một phát biểu thể hiện yêu ầu của người dùng đối với SDL", "Là cung cấp một khuôn dạng huận tiện để nhập và sửa dữ iệu", "Cung cấp các nút lệnh để gười dùng có thể sử dụng", 2], ["Ngôn ngữ truy vấn CSDL phổ iến hiện nay là:", "Access", "Excel", "Word", "SQL", 4], ["Trong SQL, ngôn ngữ định ghĩa dữ liệu bao gồm các hức năng?", "Tạo, sửa và xóa cấu trúc uan hệ. Bảo mật và quyền ruy nhập.", "Bảo mật và quyền truy nhập.", "Tạo, sửa và xóa cấu trúc uan hệ. Thêm cột, sửa cột à xoá cột", "Tạo, sửa và xóa các bộ quan ệ. Bảo mật và quyền truy hập.", 1], ["Cấu trúc cơ bảnCâu truy vấn ào một bảng dữ liệu như au:   SELECT anh_sách_các_trường FROM ên_bảng [WHERE iểu_thức_điều_kiện] Trong ó danh sách các trường được iệt kê các tên trường ngăn ách nhau bởi dấu nào?", "dấu ba chấm", "dấu chấm", "dấu chấm phẩy", "dấu phẩy", 4], ["Em hãy điền vào chỗ trống …) cho phát biểu dưới đây:  Khi thực hiện cácCâu truy ấn, hệ quản trị CSDL sẽ coi ên trường là biến trong hương trình xử lí, do vậy, ếu tên trường có chứa dấu ách thì cần phải dùng các ấu …… để đánh dấu bắt đầu à kết thúc tên trường.”", "( )", "‘ ’", "[ ]", "“ ”", 3], ["Trong mẫuCâu truy vấn của QL, em hãy cho biết mệnh đề HERE dùng để làm gì?", "Xác định điều kiện lọc dữ iệu", "Xác định dữ liệu được lấy từ âu", "Sửa dữ liệu trong bảng", "Xác định thông tin ta muốn iển thị", 1], ["Trong mẫuCâu truy vấn của QL, em hãy cho biết mệnh đề ELECT dùng để làm gì?", "Xác định điều kiện lọc dữ iệu", "Thêm dữ liệu vào bảng", "Xác định dữ liệu được lấy từ âu", "Xác định thông tin ta muốn iển thị", 4], ["Trong mẫuCâu truy vấn của QL, em hãy cho biết mệnh đề ROM dùng để làm gì?", "Xác định điều kiện lọc dữ iệu", "Xác định dữ liệu được lấy từ âu", "Xác định thông tin ta muốn iển thị", "Xóa dữ liệu trong bảng", 4], ["Trong quá trình phát triển ng dụng, truy vấn CSDL có ai trò quan trọng như thế ào?", "Chỉ dùng để thêm dữ liệu mới", "Đảm bảo tính bảo mật của CSDL", "Liên kết dữ liệu từ nhiều ảng khác nhau", "Giữ cho hệ thống hoạt động n định", 3], ["Hệ thống quản lí học sinh ủa trường em là một hệ CSDL ào?", "Hệ CSDL phân tán", "Hệ CSDL khách - chủ", "Hệ CSDL tập trung", "Hệ CSDL cá nhân", 3], ["Cơ sở dữ liệu tập trung là ì?", "CSDL tập trung là tập hợp dữ iệu được phân tán trên các áy tính khác nhau", "CSDL tập trung có toàn bộ dữ iệu được lưu trữ trên một áy tính", "các thành phần của CSDL ương tác với nhau tạo nên ệ thống gồm thành phần yêu ầu tài nguyên và thành phần ấp tài nguyên.", "những hệ thống cho phép gười dùng truy cập không hỉ dữ liệu đặt tại chỗ mà hững dữ liệu để ở xa.", 2], ["Các kiến trúc phổ biến của ệ CSDL tập trung là:", "Kiến trúc khách - chủ mà SDL thường đặt trên một máy hủ", "Kiến trúc khách - chủ, kiến rúc ngang hàng", "Kiến trúc khách - chủ mà SDL đặt trên nhiều máy chủ", "Kiến trúc ngang hàng", 1], ["Các kiến trúc phổ biến của ệ CSDL phân tán là:", "Kiến trúc khách-chủ, kiến rúc tầng 1, kiến trúc tầng , kiến túc tầng 3", "Kiến trúc khách – chủ, kiến rúc ngang hàng", "Kiến trúc khách -chủ", "Kiến trúc ngang hàng", 2], ["Trong cácCâu sau đây,Câu nào úng?", "CSDL luôn chỉ được lưu trữ à khái thác tại một máy hủ.", "Trong hệ CSDL tập trung, iệc quản lí và cập nhật dữ iệu dễ dàng hơn so với hệ SDL phân tán.", "Trong tất cả các hệ CSDL, ếu có sự cố không truy cập ược một máy chủ CSDL thì oàn bộ hệ thống CSDL đó gừng hoạt động.", "Một hệ CSDL tập trung đắt ơn  so với một hệ CSDL phân án vì nó phức tạp hơn hiều.", 2], ["Phát biểu nào ĐÚNG khi nói ề hệ CSDL tập trung?", "Hệ CSDL tập trung khó khăn ơn trong đảm bảo tính nhất uán dữ liệu và tính an ninh", "Hệ CSDL tập trung chi phí ao hơn hệ CSDL phân tán", "Trong quá trình khai thác, ếu hệ CSDL tập trung gặp sự ố thì các chương trình ứng ụng CSDL không thể chạy ược", "Hệ CSDL tập trung có thể cho hiều người truy cập cùng úc", 3], ["Các yếu tố tham gia trong iệc bảo mật hệ thống như ật khẩu, mã hoá thông tin ần phải", "Không được thay đổi để đảm ảo tính nhất quán", "Chỉ nên thay đổi nếu người ùng có yêu cầu", "Phải thường xuyên thay đổi ể tằng cường tính bảo mật", "Chỉ nên thay đổi một lần sau hi người dùng đăng nhập vào ệ thống lần đầu tiên.", 3], ["Bảo vệ sự an toàn của hệ SDL là rất quan trọng vì:", "Bất kì một hỏng hóc hay mất át nào cũng sẽ ảnh hưởng ến hoạt động hằng ngày của ột tổ chức và hiệu suất làm iệc của mọi người", "Rất nhiều loại dữ liệu được ải về giữ trên các máy cục ộ để khai thác", "Một bộ sưu tập rất lớn về ác loại dữ liệu tác nghiệp", "Truy xuất vào cơ sở dữ liệu ằng nhiều ngôn ngữ thao tác ữ liệu khác nhau", 1], ["Thông thường, người dùng uốn truy cập vào hệ CSDL ần cung cấp", "Hình ảnh", "Tên tài khoản và mật khẩu", "Họ tên người dùng", "Chữ ký", 2], ["Phát biểu nào dưới ây không phải là bảo mật hông tin trong hệ CSDL?", "Khống chế số người sử dụng SDL", "Hạn chế tối đa các sai sót ủa người dùng", "Đảm bảo thông tin không bị ất hoặc bị thay đổi ngoài ý uốn", "Ngăn chặn các truy cập không ược phép", 1], ["Phát biểu nào dưới đây SAI hi nói về mã hoá thông tin?", "Các thông tin quan trọng và hạy cảm nên lưu trữ dưới ạng mã hoá", "Mã hoá thông tin để giảm khả ăng rò rỉ thông tin", "Nén dữ liệu cũng góp phần ăng cường tính bảo mật của ữ liệu", "Các thông tin sẽ được an oàn tuyệt đối sau khi đã ược mã hoá", 4], ["Access là gì?", "Phần mềm hệ quản trị CSDL", "Phần mềm trò chơi", "Phần mềm hệ thống", "Thiết bị phần cứng", 1], ["Trong cửa sổ làm việc Access ác thẻ (tab): File, Home, reate, External Data, atabase Tools… thuộc:", "Vùng nút lệnh", "Vùng điều hướng", "Vùng làm việc", "Vùng thay đổi khung nhìn", 1], ["Vùng điều hướng của cửa sổ àm việc của Access hiển thị hững gì?", "Các thẻ File, Home, Create, xternal Data…", "Các đối tượng trong CSDL", "Các nút lệnh để thay đổi hung nhìn", "Nội dung của đối tượng", 2], ["Có mấy khung nhìn bảng:", "2", "3", "4", "5", 1], ["Một cơ sở dữ liệu của Acess 65 có bao nhiêu thành phần rong một cửa sở làm việc?", "1 thành phần duy nhất là ùng nút lệnh", "4 thành phần : vùng nút ệnh, vùng điều hướng, vùng àm việc và vùng thay đổi hung nhìn", "6 thành phần : Tables, ueries, Forms, Reports, acros, Pages", "7 thành phần : Tables, ueries, Forms, Reports, acros, Pages, Modules", 4], ["Để tạo cơ sở dữ liệu mới từ lank desktop database tại àn hình khởi động Access, a có các thao tác sau:  1). Nháy chuột chọn Blank esktop database (2). Chọn ile\\New (3). Nhấn nút lệnh reate Trình tự thực hiện ác thao tác là:", "(1)  (2) (3)", "(2)  (1) (3)", "(3)  (2) (1)", "(1)  (3) (2)", 2], ["Một bảng điểm học sinh trong ccess có các cột chứa điểm Toán”, “Tin học” các cột ày ta chọn kiểu dữ liệu ào?", "AutoNumber", "Number", "Long Text", "Yes/No", 2], ["Trong khung nhìn thiết kế ảng, để chọn kiểu dữ liệu ho 1 trường (cột) ta chọn ở ột nào?", "Field Properties", "Field Name", "Data Type", "Description", 3], ["Để nhập dữ liệu cho bảng, ta hải hiển thị bảng ở:", "khung nhìn thiết kế", "khung nhìn bảng dữ liệu", "khung nhìn thiết kế và khung hìn bảng dữ liệu", "bất kì khung nhìn nào cũng ược", 2], ["Trong Access, để tạo đối ượng mới ta nháy chuột chọn hẻ:", "File", "Home", "Create", "Database Tools", 3], ["Ở khung nhìn thiết kế, để họn một cột làm khóa chính, a chọn cột đó rồi nháy vào út lệnh:", "Delete Rows", "Inser Rows", "Insert Colunns", "Primary Key", 4], ["Trong Access nói riêng và SDL quan hệ nói chung, giữa ai bảng chỉ có mối quan hệ:", "một – một (1-1)", "một – nhiều (1-∞)", "một – một (1-1) hoặc một – hiều (1-∞)", "một – một (1-1) và một – hiều (1-∞)", 3], ["Điều kiện cần để tạo được iên kết là", "Phải có ít nhất hai bảng", "Phải có ít nhất một bảng và ột mẫu hỏi", "Phải có ít nhất một bảng mà ột biểu mẫu", "Tổng số bảng và mẫu hỏi ít hất là 2", 1], ["Muốn xóa liên kết giữa hai ảng, trong cửa sổ elationships ta thực hiện", "Chọn hai bảng và nhấn phím elete", "Chọn đường liên kết giữa hai ảng đó và nhấn phím Delete", "Chọn tất cả các bảng và nhấn hím Delete", "Nháy nút lệnh Edit elationship", 2], ["Điều kiện để tạo mối liên ết giữa hai bảng là", "Trường liên kết của hai bảng hải có tên giống nhau và ùng kiểu dữ liệu", "Trường liên kết của hai bảng hải là chữ hoa, có cùng iểu dữ liệu", "Trường liên kết của hai bảng hải là kiểu dữ liệu số", "Trường liên kết của hai bảng hải khác nhau", 1], ["Để tạo quan hệ giữa hai bảng hì ta làm sao?", "Kéo thả trường khóa ngoài ủa bảng con vào trường khóa hính của bảng mẹ", "Kéo thả trường khóa ngoài ủa bảng con vào 1 trường ất kì của bảng mẹ", "Kéo thả trường khóa chính ủa bảng mẹ vào 1 trường bất ì của bảng con", "Kéo thả 1 trường của bảng on vào 1 trường của bảng mẹ", 1], ["Nhận định nào sau đây là SAI?", "Để xóa một liên kết, nháy úp vào đường nối thể hiện iên kết để chọn nó rồi nhấn hím Delete", "Để xóa một liên kết, nháy huột vào đường nối thể hiện iên kết để chọn nó rồi nhấn hím Delete", "Để sửa liên kết, nháy đúp ào đường nối thể hiện liên ết để mở lại hộp thoại Edit elationships.", "Để mở vùng làm việc với các ối quan hệ, ta chọn atabase Tools\\Relationships", 1], ["Nội dung nào sau đây SAI về iên kết các bảng trong cơ ở dữ liệu?", "Access có trình tiện ích ookout Wizard giúp thiết ập mối quan hệ khóa ngoài à khóa chính giữa hai bảng", "Một bảng có thể liên kết với hiều bảng khác", "Các thao tác thiết lập, hỉnh sửa, xóa mối quan hệ iữa hai bảng trong CSDL bắt ầu bằng chọn Database ools\\ Relationships", "Thiết lập kiểu dữ liệu từ ra cứu sẽ đảm bảo toàn vẹn ham chiếu", 1]]
