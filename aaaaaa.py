csdl_goc=[["Hệ điều hành là gì?", "Tập các chương trình điề\nkhiển giao diện và tạo giao\ndiện trung gian giữa các\nthiết bị của hệ thống với\nphần mềm ứng dụng", "Tập các chương trình điều\nkhiển và xử lí tạo giao diện\ntrung gian giữa các thiết bị\ncủa hệ thống với phần mềm ứng\ndụng", "Tập các chương trình xử lí\ntạo giao diện trung gian giữa\ncác thiết bị của hệ thống với\nphần mềm ứng dụng", "Tập các chương trình điều\nkhiển hoặc xử lí tạo giao\ndiện trung gian giữa các\nthiết bị của hệ thống với\nphần mềm ứng dụng", 2, 0], ["Hệ điều hành nào sau đây có\nmã nguồn mở?", "LINUX", "Windows XP", "MS - DOS", "macOS", 1, 0], ["Hệ điều hành nào dưới đây dựa\ntrên nền tảng của LINUX dành\ncho các thiết bị di động có\nmàn hình cảm ứng như điện\nthoại thông minh, máy tính\nbảng?", "Ubuntu.", "iOS.", "Android", "Windows.", 3, 0]]
