csdl_goc=[["Nội dung nào sau đây SAI vềliên kết các bảng trong cơsở dữ liệu?", "Access có trình tiện íchLookout Wizard giúp thiếtlập mối quan hệ khóa ngoàivà khóa chính giữa hai bảng", "Một bảng có thể liên kết vớinhiều bảng khác", "Các thao tác thiết lập, chỉnhsửa, xóa mối quan hệ giữahai bảng trong CSDL bắt đầubằng chọn Database Tools\\Relationships", "Thiết lập kiểu dữ liệu từ tracứu sẽ đảm bảo toàn vẹn thamchiếu", "1", "0"]]
